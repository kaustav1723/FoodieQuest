...
function Test() {
  ...
  <div className="container px-6 py-10 mx-auto">
    <h1 className="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">
      What our <span className="text-blue-500 font-semibold ">clients</span> say
    </h1>
    ...
    <div className="grid grid-cols-1 gap-8 mx-auto mt-8 lg:grid-cols-2 xl:mt-10 max-w-7xl">
      <div className="p-6 bg-lime-300 rounded-lg dark:bg-lime-500 md:p-8">
        <p className="leading-loose text-black dark:text-gray-300">
      ...
      <div className="p-6 bg-lime-300 rounded-lg dark:bg-gray-800 md:p-8">
        <p className="leading-loose text-black dark:text-gray-300">
          “Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore quibusdam ducimus libero ad tempora doloribus expedita laborum saepe voluptas perferendis delectus assumenda rerum, culpa aperiam dolorum, obcaecati corrupti aspernatur a.”.
        </p>
        <div className="flex items-center mt-6">
          ...
          <div className="mx-4">
            ...
            <span className="text-sm text-gray-500 dark:text-gray-300">Celebrity</span>
          </div>
        </div>
      </div>
    </div>
